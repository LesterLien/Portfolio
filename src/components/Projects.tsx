    ...
    <div className="font-bold text-white text-4xl m-3 flex flex-col justify-center items-center">
      ...
      <div className="flex flex-wrap justify-center items-center m-3 gap-6 cursor-hover w-5/6">
        {projects.map((projects, index) => (
          <Link to={`/projects/${projects.id}`} key={index}>
            <div className="w-95 h-68 bg-[#181823] outline-1 outline-[#181823] rounded-lg shadow-lg shadow-black px-5 py-6 flex flex-col m-3 transition-all duration-500 ease-in-out  hover:-translate-y-2">
